...
@section("content")
    ...
    <!-- Favicon -->
    <link href="{{ asset('public') }}/frontend/img/brand/favicon.png" rel="icon" type="image/png">
    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
    <!-- Icons -->
    <link href="{{ asset('public') }}/frontend/vendor/nucleo/css/nucleo.css" rel="stylesheet">
    <link href="{{ asset('public') }}/frontend/vendor/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet">
    <!-- Argon CSS -->
...
<div class="container-fluid">
    ...
    <a class="navbar-brand pt-0" href="{{ route('home') }}">
        <img src="{{ asset('public') }}/frontend/img/brand/blue.png" class="navbar-brand-img" alt="...">
    </a>
 <!-- User -->
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                    ...
                    <img alt="Image placeholder" src="{{ asset('public') }}/frontend/img/theme/team-1-800x800.jpg">
                    </span>
                </div>
            </a>
        ...
        <div class="navbar-collapse-header d-md-none">
            <div class="row">
                <div class="col-6 collapse-brand">
                    <a  href="{{ route('home') }}">
                        <img src="{{ asset('public') }}/frontend/img/brand/blue.png">
                    </a>
                </div>
                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h2 class="text-white mb-0">Data Ikan</h2>
                            </div>
                            <div class="col">
...
<div class="col-xl-6">
    ...
    <script src="{{ asset('public') }}/frontend/vendor/jquery/dist/jquery.min.js"></script>
        <script src="{{ asset('public') }}/frontend/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
